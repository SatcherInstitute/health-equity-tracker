...
kff_vaccination_aggregator_payload = {'dataset_name': _KFF_VACCINATION_DATASET_NAME}
...
kff_vaccination_exporter_payload = {'dataset_name': _KFF_VACCINATION_DATASET_NAME}
kff_vaccination_exporter_operator = util.create_exporter_operator(
    'kff_vaccination_exporter', kff_vaccination_exporter_payload, data_ingestion_dag)

# Ingestion DAG
kff_vaccination_bq_operator >> kff_vaccination_aggregator_operator >> kff_vaccination_exporter_operator
