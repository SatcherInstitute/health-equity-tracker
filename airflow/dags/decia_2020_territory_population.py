...
from airflow.operators.dummy_operator import DummyOperator  # pylint: disable=no-name-in-module
...
bq_payload_race_state = util.generate_bq_payload(
    _DECIA_2020_TERRITORY_POPULATION_WORKFLOW_ID,
    _DECIA_2020_TERRITORY_POPULATION_DATASET_NAME,
...
exporter_payload_age = {'dataset_name': _DECIA_2020_TERRITORY_POPULATION_DATASET_NAME, 'demographic': "age"}
...
exporter_payload_sex = {'dataset_name': _DECIA_2020_TERRITORY_POPULATION_DATASET_NAME, 'demographic': "sex"}
