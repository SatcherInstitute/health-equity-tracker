...
geo_context_bq_payload = util.generate_bq_payload(_GEO_CONTEXT_WORKFLOW_ID, _GEO_CONTEXT_DATASET_NAME)
...
# Ingestion DAG
(geo_context_pop_bq_operator >> geo_context_exporter_operator)
