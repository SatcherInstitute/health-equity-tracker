...
data_ingestion_dag = DAG(
    'graphql_ahr_non-behavioral_health_ingestion_dag',
    default_args=default_args,
    schedule_interval=None,
    description='Ingestion configuration for all non-behavioral health topics from GRAPHQL AHR',
)
...
# EXPORTERS
payload_age = {'dataset_name': _GRAPHQL_AHR_DATASET_NAME, 'category': 'non-behavioral_health', 'demographic': "age"}
...
payload_sex = {'dataset_name': _GRAPHQL_AHR_DATASET_NAME, 'category': 'non-behavioral_health', 'demographic': "sex"}
