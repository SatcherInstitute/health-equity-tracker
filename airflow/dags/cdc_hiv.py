...
cdc_hiv_bq_operator = util.create_aggregator_operator(
    'cdc_hiv_to_bq', cdc_hiv_bq_payload, data_ingestion_dag)

cdc_hiv_payload = {'dataset_name': _CDC_HIV_DATASET_NAME}
cdc_hiv_operator = util.create_bq_ingest_operator(
    'cdc_hiv_exporter', cdc_hiv_payload, data_ingestion_dag)
