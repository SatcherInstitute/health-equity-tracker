...
cawp_time_bq_payload = util.generate_bq_payload(_CAWP_TIME_WORKFLOW_ID, _CAWP_TIME_DATASET_NAME)
cawp_time_pop_bq_operator = util.create_bq_ingest_operator("cawp_time_to_bq", cawp_time_bq_payload, data_ingestion_dag)

cawp_time_exporter_payload_race = {"dataset_name": _CAWP_TIME_DATASET_NAME, "demographic": "race_and_ethnicity"}
...
# Ingestion DAG
(cawp_time_pop_bq_operator >> cawp_time_exporter_operator_race)
