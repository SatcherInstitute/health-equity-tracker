...
data_ingestion_dag = DAG(
    ...
    description='Ingestion configuration for BJS_INCARCERATION')

bjs_incarceration_bq_payload = util.generate_bq_payload(
    _BJS_INCARCERATION_WORKFLOW_ID, _BJS_INCARCERATION_DATASET_NAME)
bjs_incarceration_pop_bq_operator = util.create_bq_ingest_operator(
...
# Ingestion DAG
bjs_incarceration_pop_bq_operator >> bjs_incarceration_aggregator_operator >> bjs_incarceration_exporter_operator
