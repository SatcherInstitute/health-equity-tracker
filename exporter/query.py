...
# # from ingestion.constants import STATE_LEVEL_FIPS_TO_NAME_MAP
...
# # for every county-level table in this source
# for table in tables:
...
#     # split apart the county data by parent state/territory and write to S3 for frontend use
