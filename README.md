...
|-------------|-----------|---------------------|---------------------|-------------|
| Local Development | `.env.local` (create manually) | Local machine's <http://localhost:3000> | het-infra-test | For developer workstations. |
...
1. **Copy from an existing environment file:**
   ```bash
