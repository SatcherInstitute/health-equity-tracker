...
_expected_pct_share_data = [
    ...
    ['01', 'Alabama', 'Asian alone', '66', '28.95'],
    ['01', 'Alabama', 'Some other race alone', '70', '30.7'],
    ['01', 'Alabama', 'Two or more races', '92', '40.35'],
    ['01', 'Alabama', 'TOTAL', '228', '100'],
    ['02', 'Alaska', 'Asian alone', '45', '38.79'],
    ['02', 'Alaska', 'Some other race alone', '11', '9.48'],
    ['02', 'Alaska', 'Two or more races', '60', '51.72'],
    ['02', 'Alaska', 'TOTAL', '116', '100'],
    ['04', 'Arizona', 'Asian alone', '23', '24.21'],
    ['04', 'Arizona', 'Some other race alone', '46', '48.42'],
    ['04', 'Arizona', 'Two or more races', '26', '27.37'],
