...
ALLS_DATA = {
    'all_national': os.path.join(TEST_DIR, PHRMA_DIR, 'hiv-national-all.csv'),
    'all_state': os.path.join(TEST_DIR, PHRMA_DIR, 'hiv-state-all.csv')}
...
@mock.patch('datasources.cdc_hiv.PhrmaData.generate_breakdown_df', side_effect=_generate_breakdown_df)
