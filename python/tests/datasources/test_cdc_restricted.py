...
#     print(df.sort_values(by=['time_period', 'county_name', 'sex']).reset_index(drop=True).to_string())
#     assert_frame_equal(
#         df.sort_values(by=sortby_cols).reset_index(drop=True),
#         expected_df.sort_values(by=sortby_cols).reset_index(drop=True),
#         check_like=True,
...
#               'table_name': 'output_table', 'cumulative': False}
...
#     assert mock_bq.call_args_list[0].args[2] == 'by_sex_national_processed_time_series'
#     assert mock_bq.call_args_list[1].args[2] == 'by_race_national_processed_time_series'
#     assert mock_bq.call_args_list[2].args[2] == 'by_age_national_processed_time_series'
#     assert mock_bq.call_args_list[3].args[2] == 'by_sex_state_processed_time_series'
#     assert mock_bq.call_args_list[4].args[2] == 'by_race_state_processed_time_series'
#     assert mock_bq.call_args_list[5].args[2] == 'by_age_state_processed_time_series'
#     assert mock_bq.call_args_list[6].args[2] == 'by_sex_county_processed_time_series'
#     assert mock_bq.call_args_list[7].args[2] == 'by_race_county_processed_time_series'
#     assert mock_bq.call_args_list[8].args[2] == 'by_age_county_processed_time_series'
...
#     kwargs = {'filename': 'test_file.csv',
#               'metadata_table_id': 'test_metadata',
#               'table_name': 'output_table', 'cumulative': True}
#     cdc_restricted.write_to_bq('dataset', 'gcs_bucket', **kwargs)
