...
def generate_state_pop_data(df):
    ...
    for source_race_code, het_race_code in RACES_MAP.items():
        needed_cols.append(het_race_code)
        df[het_race_code] = df.apply(total_race, axis=1, args=(source_race_code,))
