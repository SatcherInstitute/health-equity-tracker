...
export default function HetExpandableBoxButton(
  ...
  return (
    <button
      ...
      className={`flex w-full cursor-pointer items-center justify-between border-none bg-explore-bg-color px-4 text-left text-black text-smallest leading-list-box-title sm:text-text ${
        props.expanded
          ? ''
