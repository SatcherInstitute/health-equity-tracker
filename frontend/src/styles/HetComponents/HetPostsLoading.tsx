  ...
  return (
    <div className='grid w-full grid-cols-12 gap-4'>
      {[...Array(numberLoadingSkeletons)].map((_, i) => {
        ...
        return (
          <div
            className={`col-span-12 ${!isFirst && 'smMd:col-span-6 lg:col-span-4'} lg:col-span-4 ${isFirst && 'lg:row-span-2'} $ my-4 flex w-full flex-wrap rounded-md border border-alt-green border-solid ${props.className ?? ''}`}
            key={i}
          >
            {/* IMG PLACEHOLDER */}
            <Skeleton
