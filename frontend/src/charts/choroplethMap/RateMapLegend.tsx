    ...
    >
      <div className='w-full'>
        <div className='flex w-full flex-col items-center'>
          ...
          <div
            // all views
            className={`${LEGEND_ITEMS_BOX_CLASS} w-2/3 columns-1 tiny:columns-2 gap-1 space-y-1 border-0 border-explore-bg-color-darker border-t border-solid px-4 pt-4 ${
              props.isMulti
                ? // multimap only
