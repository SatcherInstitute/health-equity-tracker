        ...
        <Grid className={styles.ShareMenu}>
            ...
            >
                <MenuList className={styles.MenuList}>
                    <CopyLinkButton scrollToHash={props.scrollToHash} popover={shareMenu} urlWithHash={urlWithHash} />
                    <DownloadCardImageButton
                        downloadTargetScreenshot={props.downloadTargetScreenshot}
                        popover={shareMenu}
                    />
                    <CardShareIcons reportTitle={props.reportTitle} popover={shareMenu} urlWithHash={urlWithHash} />
                </MenuList>
            </Popover>
        </Grid>
    )
