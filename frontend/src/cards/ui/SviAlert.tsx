        ...
        <>
            {props.svi === undefined || props.svi === null ? (
                <Alert severity="warning" className={styles.Alert}>
                    ...
                    <b>social vulnerability index</b> for{' '}
                    <b>{props.fips.getDisplayName()}</b>. Learn more about how
                    this lack of data impacts{' '}
                    <a href={urlMap.cdcSvi}>health equity.</a>
                </Alert>
            ) : (
                <Alert severity="info" className={styles.Alert}>
                    This county has a social vulnerability index of{' '}
                    <b>{props.svi}</b>; which indicates a{' '}
                    <HashLink
                        to={`${METHODOLOGY_TAB_LINK}#svi`}
                        className={color}
                    >
