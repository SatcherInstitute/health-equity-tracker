...
import {
  ToggleBarChartCard,
  ToggleBarChartCardProps,
} from "../ToggleBarChartCard";
import { Fips, USA_FIPS } from "../../data/utils/Fips";
import { StoryWrapper } from "../../storybook/StoryWrapper";

export default {
  title: "Cards/ToggleBarChartCard",
  component: ToggleBarChartCard,
  decorators: [StoryWrapper],
} as Meta;

const Template: Story<ToggleBarChartCardProps> = (args) => (
  <ToggleBarChartCard {...args} />
);
