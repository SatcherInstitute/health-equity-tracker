import { METRIC_CONFIG, buildTopicsString } from "../../../data/config/MetricConfig"
        ...
        <section id='#community-safety'>
            <article>
                ...
                <StripedTable
                    ...
                    rows={[
                        { category: 'Community Safety', topic: communitySafetyTopicsString }
                    ]}
                />
                ...
                <section>
                    ...
                    <div className='py-5'>
                        ...
                        <p>
                            <strong>Race/ethnicity:</strong> WISQARS' methodology includes race
                            category data from 2018 onward, aligning with WISQARS’ transition
                            to single race categories from bridged race categories used in
                            previous years. The dataset does not provide information on
                            unknown races, ensuring that all race data for gun deaths are
                        ...
                        <p>
                            <strong>Sex:</strong> WISQARS data on gun deaths is categorized
                            by sex as male and female.
                        </p>
                        <p>
                            <strong>Age:</strong> WISQARS provides the age of each individual
                            at the time of death. We categorized age into the following groups:
                        </p>
                        <ul className='list-inside list-disc pl-4'>
