...
<<<<<<< HEAD
        ...
        <div className={styles.MethodologyAnswer}>
          ...
          <p>
            As of {currentDate}, we are able to calculate these age-adjusted
            ratios for{' '}
            <Link
        ...
        <ol>
          <li>
            ...
            <ul>
              <li>
                ...
                for this. It can break down by race and age to ten-year buckets.
                The age buckets are: <b>0-9</b>, <b>10-19</b>, <b>20-29</b>,{' '}
                <b>30-39</b>, <b>40-49</b>, <b>50-59</b>, <b>60-69</b>,{' '}
                <b>70-79</b>, <b>80+</b>
              </li>
          ...
          <li>
            ...
            <ul>
              <li>
                For COVID-19, the most reliable population source we could find
                with these particular age and race groupings were the{' '}
                <a href="https://www.census.gov/data/tables/time-series/demo/popest/2010s-counties-detail.html">
                  County Population by Characteristics
                </a>{' '}
        ...
        <ol>
          <li>
            <p>
              <b>
                For each race/age combination, calculate the ‘age-specific rate’
              </b>
            </p>
            <pre>
          ...
          <li>
            <p>
              <b>Calculate the expected count for each race/age combination:</b>
            </p>
            <p>
              To do this we multiply the age-specific rate by the location's
              total population for that age group. The expected condition counts
              are the number of people of the race group who would have been
              expected to have this condition if the race group had the same age
              breakdown as the population as a whole.
            </p>
            <pre>
              expected_condition_count = age_specific_rate * standard_population
              (for corresponding age group)
            </pre>
          </li>
          ...
          <li>
            ...
            <p>
              ...
              counts for that race by the expected White (NH) condition counts.
            </p>
          </li>
          <li>
            <p>
        ...
        <p>
          ...
          and <b>60+</b>. <b>Race A</b> will be the race we divide against to
          obtain our ratios (like <b>White, Non-Hispanic</b>), and <b>Race B</b>{' '}
          is any other race group.
        </p>
        ...
        <table className={styles.ExampleTable}>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>200,000</td>
              <td>
                <div className={styles.Calculation}>(5,000 / 200,000)</div>
                <b> = 0.025</b>
              </td>
            </tr>
        ...
        <table className={styles.ExampleTable}>
          ...
          <tbody>
            <tr>
              ...
              <td>0-29</td>
              <td>
                <div className={styles.Calculation}>600,000 + 200,000</div>
                <b>= 800,000</b>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>30-59</td>
              <td>
                <div className={styles.Calculation}>800,000 + 300,000</div>
                <b>= 1,100,000</b>
              </td>
            </tr>
        ...
        <table className={styles.ExampleTable}>
          ...
          <tbody>
            <tr>
              ...
              <td>
                <div className={styles.Calculation}>0.00008333 * 800,000</div>
                <b> = 66.67</b>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                <div className={styles.Calculation}>0.000625 * 1,100,000</div>
                <b> = 687.5</b>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                <div className={styles.Calculation}>0.00066667 * 1,100,000</div>
                <b> = 733.33</b>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                <div className={styles.Calculation}>0.01333333 * 260,000</div>
                <b> = 3466.67</b>
              </td>
            </tr>
          </tbody>
        ...
        <table className={styles.ExampleTable}>
          ...
          <tbody>
            <tr>
              <td>Race A</td>
              <td>
                <div className={styles.Calculation}>66.67 + 687.5 + 6,500</div>
                <b>= 7,254.17</b>
              </td>
            </tr>
            <tr>
              <td>Race B</td>
              <td>
                <div className={styles.Calculation}>80 + 733.33 + 3466.67</div>
                <b>= 4,280</b>
              </td>
            </tr>
          </tbody>
        ...
        <table className={styles.ExampleTable}>
          ...
          <tbody>
            <tr>
              ...
              <td>7,254.17</td>
              <td>
                <div className={styles.Calculation}>7,254.17 / 7,254.17</div>
                <b>= 1.0×</b>
              </td>
            </tr>
            <tr>
            ...
            >
              ...
              <div className={styles.MethodologyAnswer}>
                <p>
                  ...
                  possible in order to show a more accurate and equitable view
                ...
                <p>
                  ...
                  <Link
                    to={
                      EXPLORE_DATA_PAGE_LINK + AGE_ADJUST_HIV_DEATHS_US_SETTING
                    }
                  >
                    HIV deaths
                  </Link>
                  ...
                  <Link
                    to={
                      EXPLORE_DATA_PAGE_LINK + AGE_ADJUST_COVID_HOSP_US_SETTING
                    }
                  >
                    COVID-19 hospitalizations
                  </Link>
                  , and we present the findings in a distinct, age-adjusted
                  table. All of the other data shown on the tracker, including
                ...
                <p>
                  ...
                  used to compare race groups within each state, and <b>not</b>{' '}
                  to compare race groups between states. For COVID-19 reports,
                  we source the standard population numbers from the 2019
                ...
                <p>
                  In order to do an age-adjustment, we needed the following
                ...
                <ol>
                  ...
                  <li>
                    ...
                    <ul>
                      <li>
                        For COVID-19, the most reliable population source we
                        could find with these particular age and race groupings
                        were the{' '}
                        <a href="https://www.census.gov/data/tables/time-series/demo/popest/2010s-counties-detail.html">
                          County Population by Characteristics
                        </a>{' '}
                ...
                <ol>
                  ...
                  <li>
                    ...
                    <p>
                      ...
                      location's total population for that age group. The
                      expected condition counts are the number of people of the
                      race group who would have been expected to have this
                      condition if the race group had the same age breakdown as
                  ...
                  <li>
                    ...
                    <p>
                      If a ratio ends up being less than <b>0.1</b>, we report
                      it on the tracker as <b>Insufficient Data</b> to prevent
                ...
                <p>
                  ...
                  <b>0-29</b>, <b>30-59</b>, and <b>60+</b>. <b>Race A</b> will
                  be the race we divide against to obtain our ratios (like{' '}
                ...
                <h4 className={styles.MethodologySubsubheaderText}>
                  1) Calculate the <b>age-specific HIV death rates</b> which
                  will be each race/age group's death count divided by its
                  population.
                </h4>
                ...
                <h4 className={styles.MethodologySubsubheaderText}>
                  2) Get the <b>standard population</b> per age group, which
                  will be the summed population of all race/age groups within
                  that age group.
                </h4>
