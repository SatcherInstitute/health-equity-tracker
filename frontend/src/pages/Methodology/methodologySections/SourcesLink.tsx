...
import { AGE_ADJUSTMENT_LINK, CONTACT_TAB_LINK, DATA_CATALOG_PAGE_LINK, RESOURCES_TAB_LINK } from '../../../utils/internalRoutes'
import DatasetTable from '../methodologyContent/DatasetTable'
...
const sourceAcquisitionData: SourceAcquisitionData = {
  ...
  description: "The Health Equity Tracker is committed to providing accurate, transparent, and up-to-date information on health equity issues. This section elaborates on how we acquire, standardize, and present our data.",
  links: [
...
const SourcesLink = () => {
  const { title, description, links, listItems, nestedListItems } = sourceAcquisitionData;
      ...
      <article>
        ...
        <ul>
          <li>
            ...
            age-adjusted ratios in separate tables. To learn more, please view our{' '}
        ...
        <ul>
          <li>
            A comprehensive list of references can be found in our{' '}<a href={`${RESOURCES_TAB_LINK}`}>resources</a>{' '}section.
          </li>
        </ul>
