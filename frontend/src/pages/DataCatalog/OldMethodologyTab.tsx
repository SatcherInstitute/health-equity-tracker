		...
		<>
			...
			<div className='m-auto max-w-md px-5 py-12'>
				...
				<article className='pb-6 text-left font-sansText text-text'>
					...
					<section>
						<span id='asthma' />
						<span id='avoided_care' />
						<span id='cardiovascular_diseases' />
						<span id='chronic_kidney_disease' />
						<span id='copd' />
						<span id='depression' />
						<span id='diabetes' />
						<span id='excessive_drinking' />
						<span id='frequent_mental_distress' />
						<span id='preventable_hospitalizations' />
						<span id='substance' />
						<span id='suicide' />
						<span id='voter_participation' />
					...
					<section>
						<span id='medicare_cardiovascular' />
						<span id='medicare_hiv' />
						<span id='medicare_mental_health' />
