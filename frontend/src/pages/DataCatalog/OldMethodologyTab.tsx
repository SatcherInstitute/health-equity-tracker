      ...
      <div className='m-auto max-w-md px-5 py-12'>
        ...
        <article className='pb-6'>
          ...
          <div className='text-left font-sansText text-text'>
            ...
            <aside className='bg-standard-info px-8 py-4 shadow-raised-tighter'>
            ...
            {SHOW_PHRMA_HIV_AND_CVD && (
              <>
                      ...
                      <li>
                        ...
                        <ul>
                          <li>
                            ...
                            measurement year who were hospitalized and
                            discharged with a diagnosis of acute myocardial
                ...
                <p>
                  ...
                  we categorized racial/ethnic groups using the following
                  groups, and have adjusted the wording in some cases to use
                  more inclusive terminology and to correspond more closely with
                ...
                <p>
                  <b>Age:</b> Medicare provides the age of each beneficiary at
                  the end of the reference year (i.e., 2020), or, for
                ...
                <p>
                  ...
                  “receiving Low Income Subsidy.” Medicare beneficiaries, who
                  were{' '}
