        ...
        <article className='pb-6 text-left font-sansText text-text'>
          ...
          {SHOW_PHRMA_HIV_AND_CVD && (
            <section>
                ...
                <tbody className='even:bg-explore-bg-color'>
                  <tr>
                    ...
                    <td className='border-collapse border-solid border-bg-color p-1'>
                      ...
                      race of the beneficiary and enhanced based on first and
                      last name algorithms.
                    </td>
                  </tr>
                  <tr>
                    <td className='border-collapse border-solid border-bg-color p-1'>
                    ...
                    <li>
                      ...
                      <ul>
                        <li>
                          ...
                          and who received persistent beta-blocker treatment for
                        ...
                        {SHOW_PHRMA_MENTAL_HEALTH && (
                          <li>
                            ...
                            measures the percentage of Medicare fee-for-service
                            beneficiaries 18 years and older during the
                            measurement year with schizophrenia or
                            schizoaffective disorder who had at least two
                            prescriptions filled for any antipsychotic
                            medication and who had a Proportion of Days Covered
                            (PDC) of at least 0.8 for antipsychotic medications
              ...
              <p>
                <b>Race/ethnicity:</b> Medicare enhances the race and ethnicity
                of each beneficiary that has been used by the Social Security
                ...
                descent. Due to sample size constraints and data availability,
                we categorized racial/ethnic groups using the following groups,
                and have adjusted the wording in some cases to use more
                inclusive terminology and to correspond more closely with our
                other data sources.
              </p>
              <ul>
                <li>
              ...
              <p>
                ...
                end of the reference year (i.e., 2020), or, for beneficiaries
              ...
              <p>
                ...
                (LIS) program for Medicare Part D beneficiaries provides
                subsidies to reduce or eliminate premiums and deductibles, and
                offers zero to reduced co-payments{' '}
                <a href='https://resdac.org/cms-data/variables/current-reason-entitlement-code'>
                  for low-income Medicare Part D beneficiaries
                </a>
                . We categorized Medicare beneficiaries, who were eligible for
                the Part D LIS program, for 1 or more months during 2020 as
                “receiving Low Income Subsidy.” Medicare beneficiaries, who were{' '}
              ...
              <p>
                <b>Entitlement Qualification:</b> Medicare collects the reason
                for enrollment in Medicare. We categorized each beneficiary’s
                reason for Medicare enrollment as:
              </p>
              <ul>
