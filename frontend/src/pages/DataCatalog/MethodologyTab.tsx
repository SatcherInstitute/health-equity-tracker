        ...
        <Grid item>
          <Grid container className={styles.MethodologySection}>
            ...
            >
              ...
              <div className={styles.MethodologyAnswer}>
                <p>
                  We have decided to present age-adjusted ratios when possible
                  in order to show a more accurate and equitable view of the
                  impact on non-white communities in the United States.
                  Currently, we are able to calculate these age-adjusted ratios
                  for COVID deaths and hospitalizations, and we present the
                  findings in a distinct, age-adjusted table. All of the other
                  data shown on the tracker, including visualizations across all
                  topics, are not age-adjusted. Showing non-adjusted data can
                ...
                <ol>
                  ...
                  <li>
                    ...
                    <p>
                      The most reliable population source we could find with
                ...
                <ol>
                  ...
                  <li>
                    ...
                    <p>
                      To do this we multiply the true death rate by the
                      population of <b>White (Non-Hispanic)</b> for that age
                      group.
                      <pre>
                        expected_deaths = true_death_rate * (White
                        (Non-Hispanic) Population for age group)
                      </pre>
                    </p>
                  </li>
                  ...
                  <li>
                    ...
                    <p>
                      For each racial group, sum together the expected deaths
                      for each age group.
                    </p>
                  </li>
                ...
                <p>
                  ...
                  be the standard race we are comparing against (like{" "}
                ...
                <h4 className={styles.MethodologySubsubheaderText}>
                  First, we calculate the expected deaths for each age/race
                  group:
                </h4>
