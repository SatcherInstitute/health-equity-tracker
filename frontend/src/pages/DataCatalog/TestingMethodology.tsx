      ...
      <Grid item xs={12} className={styles.FaqQAItem} component="ul">
        <Accordion className={styles.FaqListItem}>
          <AccordionSummary
            ...
            aria-controls={`panel${0 + 1}-content`}
            id={"0"}
          >
            <Typography
            ...
            <div className={styles.FaqAnswer}>
              ...
              <ul>
                ...
                <li>
                  ...
                  population for each respective measure. See the 'What data are
                  missing' section for further details.
                </li>
                <li>
                ...
                <li>
                  ...
                  dataset vs other sources, such as the New York Times. Data for
                  a state are suppressed if the aggregate counts for that state
                  are &lt; 5% of the source being used for comparison. These
                ...
                <li>
                  ...
                  group or whether that that locale fails to report demographics
                  correctly.
                </li>
              </ul>
              ...
              <ul>
                ...
                <li>
                  ...
                  usable format. The dataset only provides data on the race and
                  ethnicity of vaccine recipients, and for the majority of
                  states counts individuals who have received at least one shot
                  as vaccinated. It does not include any data for US
                  territories.{" "}
                </li>
                <li>
              ...
              <ul>
                <li>
                  ...
                  provided by the CDC, we chose to do this because they include
                  population estimates from <b>Palau</b>, <b>Micronesia</b>, and
                  the <b>U.S. Marshall Islands,</b> which are difficult to find
                  estimations for. Furthermore the CDC has estimations for age
                  ranges that the ACS numbers do not readily provide, as they
                  use a per year population estimate from the ACS that we do not
                  use anywhere else and have not added to our system.
                </li>
                <li>
                  ...
                  Foundation, who researched exactly what the definition of each
                  demographic group in every state is. They provide population
                  estimates for <b>Asian</b>, <b>Black</b>, <b>White</b>, and{" "}
                  <b>Hispanic</b>, so we fill in the ACS 2019 estimation for{" "}
                  ...
                  comparison metric for “Unrepresented Race” because we are
              ...
              <ul>
                <li>
                  <b>Texas</b> does not report demographic-specific dose number
                  information to CDC, so data for Texas are not represented in
                  the figures and calculations on the national vaccine
                  demographic page.
                </li>
                <li>
                  <b>Idaho</b> provides vaccine data only for vaccine recipients
                  ...
                  the population aged less than 18 years. This only affects the
                  national numbers.
                </li>
                <li>
                  Some states report race and ethnicity separately, in which
                  case they report unknown percentages separately. In this case,
                  we show the higher of the two metrics on the national map of
                ...
                <li>
                  ...
                  display vaccination data as “at least one dose” which is used
                  by most states. However, some states including <b>Arkansas</b>
              ...
              <p>
                ...
                <a href={urlMap.amr}>America's Health Rankings</a>, who in turn
              ...
              <ul>
                ...
                <li>
                  BRFSS data broken down by race and ethnicity is not available
                  at the county level, so the tracker does not display these
              ...
              <p>
                ...
                have been shown to{" "}
                <a href={urlMap.doi3}>advocate for policies</a> that pertain to
                some of the crucial social and political determinants of health
                that impact the overall health of our nation such as education,
                poverty, social welfare, reproductive and maternal health,
                children, and family life. These policies in turn play a
                significant role in the advancement of health equity for all. By
              ...
              <ul>
                <li>
                  ...
                  (e.g. "What percent of women in the Georgia State Legislature
                  are black?"){" "}
                </li>
              ...
              <p>
                ...
                currently available at the state, territory, and national
              ...
              <p>
                ...
                awaiting trial or sentencing, or who are sentenced to less than
                1 year.
              </p>
              <ul>
                <li>
              ...
              <p>
                ...
                have jurisdictional control of an individual who is confined in
                a jail facility. Due to this overlap, we are currently unable to
              ...
              <ul>
                <li>
                  ...
                  the United States, but not inclusive of territorial, military,
                  or Indian Country facilities. This data is disaggregated by
                ...
                <li>
                  ...
                  data is disaggregated by race/ethnicity and sex, however the
                  BJS Prisoners report does not provide age disaggregation to
                  the state level.
                </li>
                <li>
                ...
                <li>
                  ...
                  jurisdiction of a state prison system on charges arising from
                  a criminal case in a specific county.
                </li>
              </ul>
              <p>
              ...
              <p>
                ...
                facilities), rather than only including this information as our
              ...
              <ul>
                <li>
                  ...
                  court jurisdiction and transfer to adult courts coupled with
                  the variance in state-specific laws makes it unfeasible to
                  derive an accurate population base for individuals that may be
                  ...
                  population of children down to newborns, resulting in a
                  diluted incidence rate. This can be seen on national and
                ...
                <li>
                  ...
                  for juveniles include <b>confined</b> population (literally
                  held within a specific facility), as opposed to the other
                  prison reports which present the <b>jurisdictional</b>{" "}
                  population (under the control of a facility but potentially
                  confined elsewhere).
                </li>
              </ul>
              <p>
          ...
          <AccordionDetails>
            <div className={styles.FaqAnswer}>
              ...
              >
                ...
                <div className={styles.MethodologyAnswer}>
                  <p>
                    The combined race/ethnicity groups shown on the tracker can
                    be hard to understand, partially due to non-standard
                    race/ethnicity breakdowns across data sources. Generally,
                    all race/ethnicities on the tracker include Hispanic/Latino
                  ...
                  <p>
                    ...
                    classifies race/ethnicity (e.g. the presence of "Other"
                    within a dataset changes who might be classified as "Asian"
                    vs "Other").
                  </p>
                  <ul>
                    <li>
                    ...
                    <li>
                      ...
                      : People who are either multiple races or a single race
                      not represented by the data source's categorization, and
