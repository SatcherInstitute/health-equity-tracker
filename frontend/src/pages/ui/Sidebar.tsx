    ...
    <>
      <div className='sticky' style={{ top: tocOffset }}>
        ...
        <div className='mode-selector-box'>
          <div className='rounded-sm bg-alt-white shadow-raised md:m-card-gutter md:flex md:w-90p md:flex-col md:justify-center md:px-2 md:py-4'>
        ...
        <nav
          className='m-card-gutter flex w-90p justify-center rounded-sm bg-alt-white py-4 shadow-raised'
