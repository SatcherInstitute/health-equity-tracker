...
>>>>>>> b9544580 (enable links to sample report on img and h2)
				...
				<div className='px-10 py-0 text-left smMd:px-0 md:px-10 xs:px-2'>
					...
					>
						{reportMapping.map((report, index) => (
							...
							>
								<article
									className='text-left p-4 text-altGreen flex xl:flex-row lg:flex-row md:flex-row xs:flex-wrap'
									aria-labelledby={`report-title-${index}`}
								>
									<a
									...
									<div className='flex flex-col xl:max-w-[55%] lg:max-w-[55%] md:max-w-[55%] size-auto'>
										...
										<a
											...
											<h2
												...
												aria-label={report.title}
												id={`report-title-${index}`}
												className='text-lg font-medium my-4 text-base'
											>
												{report.title} {report.icon && report.icon}
											</h2>
										</a>
