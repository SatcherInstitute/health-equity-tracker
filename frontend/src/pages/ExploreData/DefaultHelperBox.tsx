...
const EmbeddedIframe: React.FC<{ src: string }> = ({ src }) => {
  return (
    <div
      className="px-8 my-0 bg-ashgray30"
      style={{
        width: "100%",
        height: "500px",
        marginTop: "1rem",
            ...
            {reportMapping.map((report, index) => (
              ...
              >
                <div className="no-underline block text-left p-4 text-altGreen flex flex-row">
                  <div
                    className="bg-cover bg-no-repeat mr-8"
                    style={{
                ...
                <div className="flex flex-col bg-ashgray30 rounded-md m-8 p-0">
                  <button
                    onClick={(e) => {
                      e.preventDefault();
                      toggleIframe(index);
                    }}
                    className="text-text text-black font-medium text-altGreen no-underline border-none w-auto cursor-pointer bg-ashgray30 rounded-md py-4"
                  >
                    <span className="mx-1">
