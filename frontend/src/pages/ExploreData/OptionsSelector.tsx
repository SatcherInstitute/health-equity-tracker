...
function OptionsSelector(props: {
    ...
    function getGroupName(option: Fips): string {
        ...
        return `${option.getParentFips().getDisplayName()} ${
            option.getParentFips().isTerritory()
                ? ' County Equivalents'
                : ' Counties'
        }`
    }
        ...
        <>
            <span ref={popoverRef}>
                ...
                <Button
                    ...
                    aria-haspopup="true"
                    className={
                        doPulse ? styles.MadLibButtonPulse : styles.MadLibButton
                    }
                ...
                >
                    ...
                    {isFips && (
                        <div className={styles.OptionsSelectorPopover}>
                            <h3 className={styles.SearchForText}>
                                Search for location
                            </h3>
                            ...
                            <Autocomplete
                                ...
                                isOptionEqualToValue={(fips) =>
                                    fips.code === props.value
                                }
                            ...
                            <span className={styles.NoteText}>
                                ...
                                . Some source data is unavailable at county and
                                territory levels.
                            </span>
                        </div>
                    )}
