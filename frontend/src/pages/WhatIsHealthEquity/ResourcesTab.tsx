...
function ResourcesTab() {
    return (
        <>
            <Helmet>
                <title>
                    Health Equity Resources - What Is Health Equity? - Health
                    Equity Tracker
                </title>
            </Helmet>
            ...
            <Grid container className={styles.Grid}>
                <Grid container className={styles.ResourcesTabSection}>
                    {[
                        ...
                        const id =
                            heading === 'Health Equity' ? 'main' : heading
                        return (
                            <Grid
                                container
                                ...
                                <Grid item xs={12} sm={12} md={9}>
                                    <Grid container>
                                        <Grid item>
                                            <ul
                                                className={
                                                    styles.ResourcesTabList
                                                }
                                            >
                                                {resources.map((resource) => (
                                                    <li
                                                        className={
                                                            styles.ResourcesTabListItem
                                                        }
                                                        key={resource.name}
                                                    >
                                                        <a href={resource.url}>
