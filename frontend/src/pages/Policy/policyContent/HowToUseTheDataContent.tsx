...
const gunViolenceDemographicGranularities = ['Race/ethnicity', 'Sex', 'Age', 'Urbanicity (Metro/Non-Metro)'];
...
export const dataVisuals = [
    {
        ...
        details: {
            ...
            howToUse: [
                ...
                {
                    step: 'Interpret',
                    description: 'Areas with worse rates are typically highlighted with darker shades. Identify these hotspots.'
                },
                {
                    step: 'Advocate',
    ...
    },
    {
        ...
        details: {
            demographicGranularities: gunViolenceDemographicGranularities,
            geographicLevels: [...gunViolenceGeographicLevels, 'counties', 'territories'],
    ...
    },
    {
        ...
        description: 'Illustrates how the shares of gun violence in certain demographic groups compare to their respective population sizes.',
