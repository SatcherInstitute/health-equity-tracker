...
export const cityEfforts = [
	{
		title: 'Atlanta Police Department (APD) Initiatives',
		description: (
			<>
...
export const fultonCountyEfforts = [
	{
...
export const dekalbCountyEfforts = [
	{
		title: 'DeKalb County Gun Buyback Program',
		description: (
			<>
