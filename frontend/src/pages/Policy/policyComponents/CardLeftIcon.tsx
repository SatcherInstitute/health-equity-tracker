...
const CardLeftIcon: React.FC<CardLeftIconProps> = ({ title, description, advice, icon }) => {
  return (
    <li className="fade-in-up-blur flex flex-row gap-2">
      ...
      <div className="flex flex-col ">
        ...
        <p className="text-small w-fit py-0 my-0 text-altBlack">{description}</p>
      </div>
      <div className="flex flex-col">
      <p className='mb-0 mt-4 text-left font-sansTitle text-smallest font-extrabold uppercase text-altBlack tracking-widest'>
