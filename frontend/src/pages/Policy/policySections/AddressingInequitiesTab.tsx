  ...
  return (
			<>
				...
				<section id='health-inequities-definition'>
					...
					<div className='mb-8 grid lg:grid-cols-5 gap-4 grid-cols-3'>
						{links.map((link) => (
							<CombinedLink
								key={link.path}
								to={link.path}
							...
							>
								<div className='rounded-md shadow-raised p-4 group no-underline hover:scale-105 hover:transition-transform hover:duration-30'>
						...
						<ul className='list-none px-4 grid gap-8 md:grid-cols-2 grid-cols-1 py-4 my-0'>
							<li className='rounded-xl border border-solid border-altGreen md:mx-2 m-2 p-8 duration-300 ease-in-out hover:shadow-raised group bg-hoverAltGreen hover:bg-whiteSmoke80 flex flex-row align-center text-exploreButton'>
								<p className='group-hover:duration-100 ease-in-out text-center content-center'>
									...
									, indicating a more substantial increase across the US
									compared to Georgia alone.
								</p>
							</li>
							<li className='rounded-xl border border-solid border-altGreen md:mx-2 m-2 p-8 duration-300 ease-in-out hover:shadow-raised group bg-hoverAltGreen hover:bg-whiteSmoke80 flex flex-row align-center text-exploreButton'>
								<p className='group-hover:duration-100 ease-in-out text-center content-center'>
				...
				<section id='#ga-homicides'>
					<div className='mb-0'>
						...
						<ul className='list-none px-4 grid gap-8 md:grid-cols-3 grid-cols-1 py-4 my-0'>
							<li className='rounded-xl border border-solid border-altGreen md:mx-2 m-2 p-8 duration-300 ease-in-out hover:shadow-raised group bg-hoverAltGreen hover:bg-whiteSmoke80 flex flex-row align-center text-exploreButton'>
								<p className='group-hover:duration-100 ease-in-out text-center content-center'>
									Despite a decrease in firearm homicide rates for some groups
									in 2022,{' '}
									<HetTerm>overall rates remained disturbingly high</HetTerm>{' '}
									 compared to 2019, with persistent elevations particularly
					...
					<ul className='list-none'>
						<li className='flex flex-row align-center'>
							<p className='p-0 mt-0 mb-4'>
								...
								critical aspect of economic hardship. By providing access to
								basic needs, they indirectly help in reducing stressors that can
								lead to violence.
							</p>
						</li>
						<li className='flex flex-row align-center'>
							<p className='p-0 mt-0 mb-4'>
								...
								: Offers job training and employment assistance, helping to
								bridge the gap in economic opportunities and reduce
								unemployment, a key factor in economic disparities.
							</p>
						</li>
					</ul>
				</section>
					...
					<ul className='list-none'>
						<li className='flex flex-row align-center'>
							<p className='p-0 mt-0 mb-4'>
								...
								: This group works within local schools to provide resources and
								support, ensuring that children stay in school and have access
								to quality education and after-school programs.
							</p>
						</li>
						<li className='flex flex-row align-center'>
							<p className='p-0 mt-0 mb-4'>
								<a className='font-semibold no-underline text-black' href=''>
									The Atlanta Educational Telecommunications Collaborative
									(AETC)
								</a>
								: Focuses on educational programming and initiatives, aiming to
								enrich educational experiences in the community.
							</p>
						</li>
					</ul>
				</section>
					...
					<ul className='list-none'>
						<li className='flex flex-row align-center'>
							<p className='p-0 mt-0 mb-4'>
								...
								: Educates on the philosophy and methods of nonviolence and
								social change, addressing racial injustice as a core element of
								reducing violence.
							</p>
						</li>
						<li className='flex flex-row align-center'>
							<p className='p-0 mt-0 mb-4'>
								...
								: Works for equality, dignity, and justice for people impacted
								by the criminal legal system in the South, including addressing
						...
						<ul className='list-none px-4 grid gap-8 md:grid-cols-2 grid-cols-1 py-4 my-0'>
							<li className='rounded-xl border border-solid border-altGreen md:mx-2 m-2 p-8 duration-300 ease-in-out hover:shadow-raised group bg-hoverAltGreen hover:bg-whiteSmoke80 flex flex-row align-center text-exploreButton'>
								<p className='group-hover:duration-100 ease-in-out text-center content-center'>
									...
									, while rates among White individuals slightly decreased from
									22 to 21 per 100k, highlighting a concerning upward trend in
									the Black community.
								</p>
							</li>
							<li className='rounded-xl border border-solid border-altGreen md:mx-2 m-2 p-8 duration-300 ease-in-out hover:shadow-raised group bg-hoverAltGreen hover:bg-whiteSmoke80 flex flex-row align-center text-exploreButton'>
					...
					<ul className='list-none'>
						<li className='flex flex-row align-center'>
							<p className='p-0 mt-0 mb-4'>
								...
								: Offers resources, support, and education on mental health,
								helping to destigmatize and provide critical mental health
						...
						<li className='flex flex-row align-center'>
							<p className='p-0 mt-0 mb-4'>
								...
								: This organization focuses on healing and recovery from trauma,
								which is particularly important in communities affected by gun
								violence.
							</p>
						</li>
					</ul>
					...
					<ul className='list-none'>
						<li className='flex flex-row align-center'>
							<p className='p-0 mt-0 mb-4'>
								...
								high-risk individuals, and changing social norms.
							</p>
						</li>
						<li className='flex flex-row align-center'>
							<p className='p-0 mt-0 mb-4'>
								...
								in community-based programs and partnerships to promote safety
