                ...
                >
                    ...
                    >
                        ...
                        <Typography
                            ...
                            paragraph={true}
                        >
                            Health equity can't exist without equitable data.
                            That's why we're aiming to collect health equity
                            data from across the United States and centralize it
                            all in one place.
                        </Typography>
                    </Grid>
                    <Grid
                    ...
                    >
                        ...
                        >
                            ...
                            <Typography variant="body1" paragraph={true}>
                                Prompted by the COVID-19 pandemic, the Health
                                Equity Tracker was created in 2020 to aggregate
                                up-to-date demographic data from the hardest-hit
                                communities.
                            </Typography>
                            <Typography variant="body1" paragraph={true}>
                                The Health Equity Tracker aims to give a
                                detailed view of health outcomes by race,
                                ethnicity, sex, and other critical factors. Our
                                hope is that it will help policymakers
                                understand what resources and support affected
                                communities need to be able to improve their
                                outcomes.
                            </Typography>
                        </Grid>
                            ...
                            >
                                <Grid item xs={12} sm={12} md={5}>
                                    ...
                                    >
                                        ...
                                        >
                                            {`${numDataSources}`} key data
                                            sources
                                        </LinkWithStickyParams>
                                        , including the CDC and the U.S. Census
                                        Bureau. We’ll continue adding to these
                                        initial sources as data access and
                                        quality improves.
                                    </Typography>
                                </Grid>
                                <Grid item xs={12} sm={12} md={5}>
                                    ...
                                    >
                                        ...
                                        >
                                            hospitalizations by race to the
                                            county level
                                        </LinkWithStickyParams>
                                        , the tracker also covers chronic
                                        ...
                                        , and social and political determinants
                                        of health including{' '}
                                        <LinkWithStickyParams
                                            to={
                                                EXPLORE_DATA_PAGE_LINK +
