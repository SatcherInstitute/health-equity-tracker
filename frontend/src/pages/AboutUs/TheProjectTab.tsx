      ...
      <Grid container className={styles.Grid}>
        <Grid container className={styles.GridOutlinedImgRow}
          ...
          <Grid item xs={7} className={styles.GridAlignRightItem}>
            <img src="img/pexels-ketut-subiyanto-4473871 1.png"
            ...
            <Grid item xs={5} className={styles.GridVerticallyAlignedItem}>
              ...
              <Typography>
                ...
                <p>
                  ...
                  outcomes by race, ethnicity, gender, socioeconomic status, and
                ...
                <Grid item xs={5}>
                  ...
                  <Typography className={styles.HeaderSubtextL3}>
                    <p>
                      ...
                      tracker also covers conditions like COPD, asthma, diabetes,
                      hypertension, obesity, SDOH, and more
                    </p>
                  </Typography>
                </Grid>
                <Grid item xs={12}>
                ...
                <Grid item>
                  <Typography className={styles.HeaderSubtextL2}>
                    <p>
                      ...
                      data, we will have more information to share on disparities
                      and the equity impact of COVID-19.
                    </p>
                  </Typography>
                </Grid>
              </Grid>
            ...
            <Grid item xs={4} className={styles.AimToGoItem}>
              <Grid container
                ...
                <Grid item>
                  <Typography className={styles.HeaderSubtextL2}>
                    <p>
                      It’s important to track progress, so we plan to develop and
                      publish more health equity reports and analyses.
                    </p>
                  </Typography>
                </Grid>
              </Grid>
