        ...
        <Grid container className={styles.Grid}>
          ...
          >
            ...
            <Grid item xs={6} className={styles.HeaderImgItem}>
              <img src="img/shutterstock_1414416191 2 (1).png"
              ...
              <Grid item xs={4} className={styles.TakeALookAroundItem}>
                ...
                >
                  ...
                  <Grid item>
                    <Typography className={styles.HeaderSubtextL2}>
                      <p>
                        (3) Share our site and join our movement
                      </p>
                    </Typography>
                  </Grid>
                </Grid>
          ...
          <Grid container className={styles.GridOutlinedRow}>
            ...
            xs={12}>
              ...
              >
                <Grid item xs={8}>
                  <img className={styles.HowToStepImg}
                      src="img/ezgif 2.png"
                ...
                <Grid item xs={3}>
                  <div>
                    ...
                    <p className={styles.HowToTextSubheader}>
                      Select variables you’re interested in
                      to complete the sentence and explore the data
                    </p>
                  </div>
                </Grid>
              </Grid>
            ...
            <Grid item xs={12} className={styles.FaqQAItem}>
              ...
              <Accordion>
                ...
                <AccordionDetails>
                  <div className={styles.FaqAnswer}>
                    <ul>
                      <li>Our data is retrieved via a mix of APIs and manual downloads</li>
                      <li>Once acquired, this data is converted to tables in Google BigQuery</li>
                      <li>During this process, values are standardized and normalized to facilitate reporting, comparison and visualization</li>
