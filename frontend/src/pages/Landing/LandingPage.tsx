        ...
        <>
            <Helmet>
                ...
                <link
                    rel="preload"
                    as="image"
                    href="/img/stock/family-laughing.png"
                />
            </Helmet>
                ...
                >
                    ...
                    >
                        ...
                        <Typography
                            ...
                            paragraph={true}
                        >
                            Our tracker puts Health Equity first. Envisioned by
                            the Satcher Health Leadership Institute, the Health
                            Equity Tracker is designed to boost inclusivity,
                            highlight at-risk populations, alert users to
                            existing inequities in health data, and so much
                            more.
                        </Typography>
                        ...
                        <Typography
                            ...
                            paragraph={true}
                        >
                            Our goal for this tool is to support the work being
                            done by policymakers, community leaders,
                            researchers, and ultimately all champions for health
                            equity.{' '}
                            <Link to={EXPLORE_DATA_PAGE_LINK}>
                                Explore our tracker today
                            </Link>{' '}
                            and find data to help your community reach their
                ...
                >
                    ...
                    <Grid item xs={12}>
                        <Typography
                            ...
                            component="p"
                        >
                            News and stories from the Satcher Health Leadership
                    ...
                    <Grid item xs={12}>
                        ...
                        <Box mt={5}>
                            <Typography
                                className={
                                    styles.PrioritizeHealthEquityHeaderSubtext
                                }
                                variant="body1"
                                paragraph={true}
                            >
                                <ReactRouterLinkButton
                                    url={NEWS_TAB_LINK}
                                    className={
                                        styles.LearnMoreAboutHealthEquity
                                    }
                        ...
                        >
                            <Grid item xs={12} sm={12} md={3}>
                                ...
                                <p className={styles.HowToStepTextSubheader}>
                                    New to the Health Equity Tracker? Watch a
                                    short video demo that highlights major
                ...
                encrypted-media; gyroscope; picture-in-picture"
                        ...
                        >
                            <Grid item xs={12} sm={12} md={3}>
                                ...
                                <p className={styles.HowToStepTextSubheader}>
                                    Select variables you’re interested in to
                                    complete the sentence and explore the data.
                                </p>
                            </Grid>
                            <Grid item xs={12} sm={12} md={8}>
                                <LazyLoad offset={300} once>
                        ...
                        >
                            <Grid item xs={12} sm={12} md={3}>
                                <div>
                                    ...
                                    <p
                                        className={
                                            styles.HowToStepTextSubheader
                                        }
                                    >
                                        Where available, the tracker offers
                                        breakdowns by race and ethnicity, sex,
                                        and age.
                                    </p>
                                </div>
                            </Grid>
                        ...
                        >
                            <Grid item xs={12} sm={12} md={3}>
                                <div>
                                    ...
                                    >
                                        The interactive maps and graphs are a
                                        great way to investigate the data more
                                        closely. If a state or county is gray,
                                        that means there’s no data currently
                                        available.
                                    </p>
                                </div>
                            </Grid>
