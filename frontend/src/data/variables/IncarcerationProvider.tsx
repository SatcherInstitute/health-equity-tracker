...
export function CombinedIncarcerationStateMessage() {
    return (
        <>
            ...
            <b>Rhode Island</b>, and <b>Vermont</b> each operate an integrated
            system that combines both prisons and jails; for our reports these
            are treated only as prison facilities.
        </>
    )
}
    ...
    getDatasetId(breakdowns: Breakdowns): string {
        if (breakdowns.geography === 'national') {
            ...
            if (breakdowns.hasOnlyAge())
                return 'bjs_incarceration_data-age_national'
            if (breakdowns.hasOnlySex())
                return 'bjs_incarceration_data-sex_national'
        }
        if (breakdowns.geography === 'state') {
            ...
            if (breakdowns.hasOnlyAge())
                return 'bjs_incarceration_data-age_state'
            if (breakdowns.hasOnlySex())
                return 'bjs_incarceration_data-sex_state'
        }
