...
import Decia2010PopulationProvider from "../variables/Decia2010PopulationProvider";
...
export default class VariableProviderMap {
  ...
  constructor() {
    ...
    const decia2010Provider = new Decia2010PopulationProvider();
    this.providers = [
      acsProvider,
      decia2010Provider,
