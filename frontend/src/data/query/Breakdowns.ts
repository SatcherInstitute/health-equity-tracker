...
// union type of array
export type DemographicTypeKey = (typeof DEMOGRAPHIC_TYPES)[number]

export const DEMOGRAPHIC_TYPE_DISPLAY_NAMES: Record<DemographicType, string> = {
...
export type DemographicTypeDisplayName =
  (typeof DEMOGRAPHIC_TYPE_DISPLAY_NAMES)[keyof typeof DEMOGRAPHIC_TYPE_DISPLAY_NAMES]

export const DEMOGRAPHIC_TYPE_DISPLAY_NAMES_LOWER_CASE: Record<
  DemographicType,
  string
> = {
  race_and_ethnicity: 'race and ethnicity',
...
export class Breakdowns {
  ...
  constructor(
    geography: GeographicBreakdown,
    demographicBreakdowns?: Record<DemographicTypeKey, DemographicBreakdown>,
    time = false,
