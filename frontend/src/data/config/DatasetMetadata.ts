...
export const datasetMetadataList: DatasetMetadata[] = [
  ...
  },
  {
    ...
    name: 'Phrma Dataset by Medicare eligibility reason, nationally (Naming TBD)',
    update_time: '2020',
  },
  {
    id: 'phrma_data-eligibility_state',
    name: 'Phrma Dataset by Medicare eligibility reason, by state (Naming TBD)',
    update_time: '2020',
  },
  {
    id: 'phrma_data-eligibility_county',
    name: 'Phrma Dataset by Medicare eligibility reason, by county (Naming TBD)',
    update_time: '2020',
  },
]
