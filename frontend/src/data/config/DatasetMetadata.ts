...
export const datasetMetadataList: DatasetMetadata[] = [
  ...
  },
  {
    ...
    name: "HIV diagnoses, deaths, and PrEP by race/ethnicity and county",
    update_time: "2019",
    contains_nh: true,
  },
  {
    id: "cdc_hiv_data-race_and_ethnicity_state_time_series",
    name: "HIV diagnoses, deaths, and PrEP by race/ethnicity and state",
    update_time: "2019",
    contains_nh: true,
  },
  {
    id: "cdc_hiv_data-race_and_ethnicity_national_time_series",
    name: "HIV diagnoses, deaths, and PrEP by race/ethnicity nationally",
    update_time: "2019",
    contains_nh: true,
  },
  {
    id: "cdc_hiv_data-age_county_time_series",
    name: "HIV diagnoses, deaths, and PrEP by age and county",
    update_time: "2019",
    contains_nh: true,
  },
  {
    id: "cdc_hiv_data-age_state_time_series",
    name: "HIV diagnoses, deaths, and PrEP by age and state",
    update_time: "2019",
    contains_nh: true,
  },
  {
    id: "cdc_hiv_data-age_national_time_series",
    name: "HIV diagnoses, deaths, and PrEP by age nationally",
    update_time: "2019",
    contains_nh: true,
  },
  {
    id: "cdc_hiv_data-sex_county_time_series",
    name: "HIV diagnoses, deaths, and PrEP by sex and county",
    update_time: "2019",
    contains_nh: true,
  },
  {
    id: "cdc_hiv_data-sex_state_time_series",
    name: "HIV diagnoses, deaths, and PrEP by sex and state",
    update_time: "2019",
    contains_nh: true,
  },
  {
    id: "cdc_hiv_data-sex_national_time_series",
    name: "HIV diagnoses, deaths, and PrEP by sex nationally",
    update_time: "2019",
    contains_nh: true,
  },
  {
