...
export const dataSourceMetaDataMap: Record<DataSourceId, DataSourceMetadata> =
{
  ...
  "acs": {
    ...
    "data_source_link": "https://www.census.gov/data/developers/data-sets/acs-5year.html",
    "geographic_level": "National, State, County",
    "demographic_granularity": "Race/ethnicity, age, sex",
    "update_frequency": "Annual",
    "description": "Yearly population percentages, health insurance rates, and poverty rates at the national, state and county levels.",
    "dataset_ids": [
  ...
  "decia_2010_territory_population": {
    ...
    "data_source_pretty_site_name": "census.gov",
    "data_source_link": "https://www.census.gov/data/datasets/2010/dec/virgin-islands.html",
    "geographic_level": "Territory",
    "demographic_granularity": "Race/ethnicity, age, sex",
    "update_frequency": "None",
    "description": "Population totals and percent shares for 2010 at the territory level for U.S. Virgin Islands, Guam, American Samoa, and the Northern Mariana Islands, which are not available in the Census 5 year American Community Survey (ACS) estimates.",
    "dataset_ids": [
  ...
  "decia_2020_territory_population": {
    ...
    "data_source_pretty_site_name": "census.gov",
    "data_source_link": "https://www.census.gov/data/tables/2020/dec/2020-us-virgin-islands.html",
    "geographic_level": "Territory/County-Equivalent",
    "demographic_granularity": "Race/ethnicity, age, sex",
    "update_frequency": "None",
    "description": "Population totals and percent shares for 2020 at the territory and county-equivalent level for U.S. Virgin Islands, Guam, American Samoa, and the Northern Mariana Islands, which are not available in the 5 year American Community Survey (ACS) estimates.",
    "dataset_ids": [
  ...
  "census_pop_estimates": {
    ...
    "data_source_pretty_site_name": "census.gov",
    "data_source_link": "https://www.census.gov/data/tables/time-series/demo/popest/2010s-counties-detail.html",
    "geographic_level": "State/County",
    "demographic_granularity": "Race/ethnicity, age, sex",
    "update_frequency": "None",
    "description": "Population percentage estimates by race/ethnicity, age, and sex to the county level provided by the U.S Census Bureau. We use the single year estimates from 2019.",
    "dataset_ids": [
  ...
  "cdc_svi_county": {
    ...
    "data_source_link": "https://www.atsdr.cdc.gov/placeandhealth/svi/documentation/SVI_documentation_2018.html",
  ...
  "cdc_vaccination_county": {
    ...
    "data_source_pretty_site_name": "data.cdc.gov",
    "data_source_link": "https://data.cdc.gov/Vaccinations/COVID-19-Vaccinations-in-the-United-States-County/8xkx-amqh",
    "geographic_level": "County",
    "demographic_granularity": "None",
  ...
  "cdc_vaccination_national": {
    ...
    "data_source_name": "CDC COVID-19 Vaccination Demographics in the United States, National",
    "data_source_pretty_site_name": "data.cdc.gov",
    "data_source_link": "https://data.cdc.gov/Vaccinations/COVID-19-Vaccination-Demographics-in-the-United-St/km4m-vcsb",
  ...
  "bjs": {
    ...
    "description": "Rates of individuals, including children, who are confined in a local adult jail facility, or under the jurisdiction of a federal, state, or territory adult prison facility.",
    "dataset_ids": [
  ...
  "vera": {
    ...
    "update_frequency": "None",
    "description": "Rates of individuals, including children, who are confined in local adult jail facilities, or under the jurisdiction of a state prison system on charges arising from a criminal case in a specific county.",
    "dataset_ids": [
  ...
  "cawp": {
    ...
    "geographic_level": "National, State",
    "time_period_range": "U.S. Congress: 1915 - Current, State Legislatures: 1983 - Current",
    "demographic_granularity": "Race/ethnicity",
    "update_frequency": "Monthly",
    "description": "Detailed information on women legislators, by race/ethnicity, in the US Congress and state legislatures, and historical counts of total state legislators of any gender by year by state. A separate table is also available containing legislator names and positions.",
    "dataset_ids": [
  ...
  "the_unitedstates_project": {
    ...
    "description": "Total members of the United States Congress (Senate and House of Representatives including Delegates) both nationally and by state/territory. This dataset is viewable and downloadable in the CAWP datasets.",
    "dataset_ids": [
      "the_unitedstates_project"
    ],
    "downloadable": false
  ...
  "geo_context": {
    ...
    "data_source_pretty_site_name": "github.com/SatcherInstitute/health-equity-tracker",
    "data_source_link": "https://github.com/SatcherInstitute/health-equity-tracker",
    "geographic_level": "National, State, County",
    "demographic_granularity": "N/A",
    "update_frequency": "Yearly",
    "description": "This is a composite dataset we create for faster loading; it includes population data from ACS and SVI data at the county level from the CDC.",
    "dataset_ids": [
      "geo_context-county",
      "geo_context-state",
  ...
  "phrma": {
    "id": "phrma",
    "data_source_name": "Medication Utilization and Disease Rates in the Medicare Population",
    "data_source_pretty_site_name": "cms.gov",
    "data_source_link": "https://www.cms.gov/research-statistics-data-and-systems/cms-information-technology/accesstodataapplication",
    "geographic_level": "National, State, County",
    "demographic_granularity": "Race/ethnicity, sex, age, low-income subsidy (LIS), Medicare eligibility",
    "update_frequency": "None",
    ...
    "downloadable": true,
    "downloadable_blurb": "Disease rates and medication adherence percentages for multiple HIV, mental health, and cardiovascular conditions within the Medicare beneficiary population.",
  ...
  "covid_tracking_project": {
    ...
    "description": "The numbers of confirmed COVID-19 deaths, cases, hospitalizations, and tests at the state level. Please note that Covid Tracking Project data is not used for any visualizations on the tracker, it is only available for download.",
    "dataset_ids": [
  ...
  "geographies_source": {
    ...
    "demographic_granularity": "N/A",
    "update_frequency": "None",
    "description": "This dataset contains the geographic boundaries for the United States, states, territories, counties, and county-equivalents.",
    "dataset_ids": [
