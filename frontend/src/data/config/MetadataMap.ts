...
const dataSourceMetadataList: DataSourceMetadata[] = [
  ...
  },
  {
    ...
    description:
      ...
      "Surveillance Data Access, Summary, and Limitations (10/12/2021). The last case data included is 2 " +
      "weeks before 10/12/2021. The CDC does not take responsibility for the scientific validity " +
