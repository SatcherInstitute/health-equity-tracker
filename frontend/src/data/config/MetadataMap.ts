...
export const dataSourceMetadataList: DataSourceMetadata[] = [
  {
    ...
    description:
      ...
      "Surveillance Data Access, Summary, and Limitations (09/06/2022). The last case data included is 2 " +
      "weeks before 09/06/2022. The CDC does not take responsibility for the scientific validity " +
