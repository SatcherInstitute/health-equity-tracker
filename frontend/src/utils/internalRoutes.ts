...
export const SHARE_YOUR_STORY_TAB_LINK = `${NEWS_PAGE_LINK}/${SHARE_YOUR_STORY_PATH}`
...
export const HEALTH_EQUITY_GUIDES_TAB = `${WHAT_IS_HEALTH_EQUITY_PAGE_LINK}/guides`
...
export const BEHAVIORAL_HEALTH_LINK = `${TOPIC_CATEGORIES_LINK}/behavioral-health`
...
export const MEDICATION_UTILIZATION_LINK = `${TOPIC_CATEGORIES_LINK}/medication-utilization`
export const DATA_METHOD_DEFINITIONS_LINK = `${METHODOLOGY_PAGE_LINK}/definitions`
export const METRICS_LINK = `${DATA_METHOD_DEFINITIONS_LINK}/metrics`
export const TOPIC_DEFINITIONS_LINK = `${DATA_METHOD_DEFINITIONS_LINK}/topic-definitions`
export const RACES_AND_ETHNICITIES_LINK = `${DATA_METHOD_DEFINITIONS_LINK}/races-and-ethnicities`
export const RECOMMENDED_CITATION_LINK = `${METHODOLOGY_PAGE_LINK}/recommended-citation`
