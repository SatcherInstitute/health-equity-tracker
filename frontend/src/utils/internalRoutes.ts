...
export const METHODOLOGY_TAB_V2_LINK = '/methodology_2'
...
export const AGE_ADJUSTMENT_LINK = METHODOLOGY_TAB_V2_LINK + '/ageadjustment_2'
export const SOURCES_LINK = METHODOLOGY_TAB_V2_LINK + '/source-acquisition'
export const TOPICS_LINK = METHODOLOGY_TAB_V2_LINK + '/topics'
...
export const DATA_METHOD_DEFINITIONS_LINK =
  METHODOLOGY_TAB_V2_LINK + '/definitions'
...
export const RECOMMENDED_CITATION_LINK =
  METHODOLOGY_TAB_V2_LINK + '/recommended-citation'
