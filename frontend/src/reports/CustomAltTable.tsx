...
import { DemographicGroup, ALL, TIME_PERIOD_LABEL, AGE } from '../data/utils/Constants'
import type { DemographicType } from '../data/query/Breakdowns'
import { DataTypeConfig, formatFieldValue, isPctType } from '../data/config/MetricConfig'
