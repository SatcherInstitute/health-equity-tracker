...
const TextLink: React.FC<TextLinkProps> = ({ link, linkText, containerClassName, linkClassName, textClassName }) => {
    return (
        <div className={`flex items-center justify-start p-0 m-0 hover:translate-x-1 hover:transition-transform hover:duration-300 ${containerClassName}`}>
            <a
                href={link}
