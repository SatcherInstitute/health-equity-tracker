            ...
            <div className='flex items-center sm: items-start xs:items-start px-8 mx-8 justify-between'>
                <div className='m-auto pr-16'>
                    <div className='items-flex-start xl:inline-flex lg:inline-flex md:block sm:block xs:block'>
                        ...
                        <TextLink
                            link={METHODOLOGY_PAGE_LINK}
                            linkText='Learn more'
                            containerClassName='
                            block mt-0 mr-[auto] xl:ml-4  xl:mt-0 lg:ml-4 lg:mt-0  md:ml-0 md:mt-4   sm:ml-0  sm:mt-4  xs:ml-0 xs:mt-4 ' linkClassName='text-black mr-[auto] xl:ml-0 lg:ml-0  md:ml-0 sm:mb-0  sm:ml-0  sm:mr-[auto]  sm:mt-4 xs:mb-0  xs:ml-0  xs:mr-[auto]  xs:mt-4'
                        />
                    </div>
                </div>
