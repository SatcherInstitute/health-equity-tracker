...
const Banner: React.FC = () => {
	...
	return (
		<section className="bg-infobarColor text-center p-4">
			<div className="flex justify-between">
				<div className="flex xl:flex-row lg:flex-row md:flex-col sm:flex-col xs:flex-col items-center md:items-start sm:items-start xs:items-start m-0 p-0">
					<FlagIcon className="xl:visible lg:visible md:collapse sm:collapse xs:collapse mr-2 text-alertColor" />
					<p className="text-text p-0 my-0 text-left xl:mr-8 lg:mr-8">
