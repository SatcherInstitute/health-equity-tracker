    ...
    return (
        <div>
            ...
            >
                ...
                Structural racism and oppression create health inequities, and
                lead to missing data. Our reports reflect the best data we have,
                but we're working to close these known gaps which, in turn, will
                help us create more effective health policies in the United
                States.{' '}
