...
export function RaceRelabelingsList() {
  return (
    <aside className='px-5 pb-10'>
      ...
      <ul>
        <li className='pt-1'>
          <HetTerm>Two or more races</HetTerm> replaces the source label
          ‘Multiracial’.
        </li>

        <li className='pt-1'>
          <HetTerm>Unrepresented</HetTerm> replaces the source label ‘Some other
          race’.
        </li>

        <li className='pt-1'>
          <HetTerm>Indigenous</HetTerm> replaces the source label ‘American
