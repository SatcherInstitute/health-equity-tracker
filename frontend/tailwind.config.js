...
export default {
  ...
  theme: {
    ...
    colors: {
      ...
      "highest-lowest-color": 'rgb(var(--highest-lowest-color) / <alpha-value>)',
      ...
      "map-medicare-darkest": 'rgb(var(--map-medicare-darkest) / <alpha-value>)',
      "map-medicare-even-lighter": 'rgb(var(--map-medicare-even-lighter) / <alpha-value>)',
      "map-medicare-light": 'rgb(var(--map-medicare-light) / <alpha-value>)',
      "map-medicare-lighter": 'rgb(var(--map-medicare-lighter) / <alpha-value>)',
      "map-medicare-lightest": 'rgb(var(--map-medicare-lightest) / <alpha-value>)',
      ...
      "unknown-map-even-more": 'rgb(var(--unknown-map-even-more) / <alpha-value>)',
