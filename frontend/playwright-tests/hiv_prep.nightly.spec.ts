...
test('HIV PrEP', async ({ page }) => {
  ...
  await page.locator('#rate-map').getByRole('heading', { name: 'PrEP coverage in the United' }).click();
  await page.locator('#rate-map').getByRole('heading', { name: 'Ages 16+' }).click();
  ...
  await page.getByRole('heading', { name: 'Rates of PrEP coverage over' }).click();
  ...
  await page.getByRole('columnheader', { name: 'Time period (2017 - 2021)' }).click();
  await page.getByRole('columnheader', { name: 'All % PrEP coverage' }).click();
  await page.getByRole('columnheader', { name: 'Female % PrEP coverage' }).click();
  await page.getByRole('columnheader', { name: 'Male % PrEP coverage', exact: true }).click();
  await page.getByText('Rates of PrEP coverage over time in the United States by sex').click();
  await page.locator('#rates-over-time').getByText('Due to COVID-19\'s effects on').click();
  await page.locator('#rate-chart').getByRole('heading', { name: 'PrEP coverage in the United' }).click();
  await page.locator('#rate-chart').getByRole('heading', { name: 'Ages 16+' }).click();
  ...
  await page.locator('#inequities-over-time').getByText('Add or remove columns by').click();
  await page.locator('#inequities-over-time').getByRole('columnheader', { name: 'Time period (2017 - 2021)' }).click();
  await page.getByRole('columnheader', { name: 'Male % relative inequity' }).click();
  await page.getByText('Historical relative inequity for PrEP coverage in the United States by sex').click();
  ...
  await page.getByRole('heading', { name: 'PrEP-eligible population vs.' }).click();
  await page.locator('#population-vs-distribution').getByRole('heading', { name: 'Ages 13+' }).click();
  await page.getByRole('heading', { name: 'Breakdown summary for PrEP' }).click();
  await page.getByRole('figure', { name: 'Breakdown summary for PrEP' }).locator('h4').click();
  await page.getByRole('columnheader', { name: 'Sex' }).click();
  await page.getByRole('columnheader', { name: 'PrEP coverage', exact: true }).click();
  await page.getByRole('columnheader', { name: 'Share of total PrEP' }).click();
  await page.getByRole('columnheader', { name: 'PrEP-eligible population' }).click();
  await page.getByRole('columnheader', { name: 'Sex' }).click();
