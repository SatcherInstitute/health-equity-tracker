...
test('Covid Hospitalizations Flow', async ({ page }) => {
	...
	// TODO: MANUALLY UPDATE - this will generally be the month before the month in which new data is released
	await page.getByRole('cell', { name: 'October 2023' }).click();
	const page1Promise = page.waitForEvent('popup');

	// TODO: MANUALLY UPDATE - this will generally be the month the newest data has been released by the CDC
