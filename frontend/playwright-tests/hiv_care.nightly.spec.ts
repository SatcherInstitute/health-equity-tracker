...
test('HIV Linkage To Care', async ({ page }) => {
  ...
  await page.locator('#rate-map').getByRole('heading', { name: 'Linkage to HIV care in the' }).click();
  ...
  await page.getByRole('heading', { name: 'Rates of linkage to HIV care over time in the United States' }).click();
  ...
  await page.locator('#rate-chart').getByRole('heading', { name: 'Linkage to HIV care in the' }).click();
  await page.getByRole('button', { name: 'Unknown demographic map' }).click();
  await page.getByRole('heading', { name: 'Share of total linkage to HIV' }).click();
  ...
  await page.getByText('Add or remove columns by').click();
  await page.getByRole('columnheader', { name: 'Time period (2017 - 2021)' }).click();
  await page.getByRole('columnheader', { name: 'Ages 13-24 % relative inequity' }).click();
  await page.getByRole('columnheader', { name: 'Ages 25-34 % relative inequity' }).click();
  await page.getByText('Historical relative inequity in linkage to HIV care in the United States by age').click();
  ...
  await page.getByRole('heading', { name: 'Breakdown summary for linkage' }).click();
  await page.getByRole('figure', { name: 'Breakdown summary for linkage' }).locator('h4').click();
  ...
  await page.getByRole('columnheader', { name: 'Linkage to HIV care', exact: true }).click();
  await page.getByRole('columnheader', { name: 'Share of total linkage to HIV' }).click();
  await page.getByRole('columnheader', { name: 'Diagnosed population share (' }).click();
  ...
  await page.locator('#definitionsList').getByText('Linkage to HIV care', { exact: true }).click();
