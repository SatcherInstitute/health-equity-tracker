...
WITH
  race_and_ethnicity AS (
      SELECT DISTINCT
        ...
        a.state_name,
        a.race_category_id,
        a.copd_pct, a.diabetes_pct, a.frequent_mental_distress_pct, a.depression_pct, a.suicide_per_100k, a.illicit_opioid_use_pct, a.non_medical_drug_use_pct, a.excessive_drinking_pct,
        a.race,
