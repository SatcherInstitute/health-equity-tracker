...
WITH
  ...
  all_acs as (
    ...
    UNION ALL
      SELECT state_fips, state_name, population, population_pct, race_category_id, race_and_ethnicity FROM `decia_2010_territory_population.by_race_and_ethnicity_territory_state_level`
  ),
  joined_with_acs as (
